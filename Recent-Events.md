Recent events should utilize bing maps to include a visualization of the approximate location of the user, either by using location services, or using the zip code available in the profile. 
